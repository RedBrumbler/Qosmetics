...
{
    void NoteSelectionElement::Init(NoteManager* noteManager, NotePreviewViewController* previewViewController, NoteSwitcherViewController* switcherViewController)
    {
    ...
    void NoteSelectionElement::Delete()
    {
    ...
    void NoteSelectionElement::SetDescriptor(Descriptor* descriptor)
    {
        this->descriptor = descriptor;
        SetupButtons();
    }

    void NoteSelectionElement::SetupButtons()
    {
    ...
    custom_types::Helpers::Coroutine NoteSelectionElement::ButtonSetupRoutine()
    {
    ...
    Descriptor& NoteSelectionElement::get_descriptor()
    {
