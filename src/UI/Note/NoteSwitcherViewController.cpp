...
namespace Qosmetics::UI
{
    void NoteSwitcherViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling)
    {
        if (firstActivation)
        {
            ...
            deletionElement = modal->get_gameObject()->AddComponent<NoteDeletionElement*>();
    ...
    void NoteSwitcherViewController::AttemptDeletion(Qosmetics::UI::NoteSelectionElement* elem)
    {
