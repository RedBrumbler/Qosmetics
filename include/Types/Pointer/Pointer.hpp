...
DECLARE_CLASS_CODEGEN(Qosmetics, Pointer, UnityEngine::MonoBehaviour,
    DECLARE_INSTANCE_FIELD_DEFAULT(Qosmetics::PointerManager*, modelManager, nullptr);
    ...
    DECLARE_METHOD(void, Init, PointerManager* modelManager, ColorManager* colorManager);
