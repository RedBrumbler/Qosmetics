...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'D:/il2cpp/libil2cpp' -isystem 'extern' -I'extern/codegen/include' -DID='"Qosmetics"' -DVERSION='"1.2.0"' -I'./shared' -I'./extern' -Wno-inaccessible-base -libcurl
