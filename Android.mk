...
# Creating prebuilt for dependency: bs-utils - version: 0.4.0
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'D:/il2cpp/libil2cpp' -isystem 'extern' -I'extern/codegen/include' -DID='"Qosmetics"' -DVERSION='"1.0.2"' -I'./shared' -I'./extern' -Wno-inaccessible-base
